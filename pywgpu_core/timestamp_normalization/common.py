"""
Common WGSL routines for timestamp normalization.

This file contains helper functions for 64-bit and 96-bit arithmetic
since WGSL doesn't have native 64-bit integer support.
"""
