...
class DeviceOps:
    ...
    def device_create_buffer(
        self, device_id: Any, desc: BufferDescriptor, id_in: Optional[Any] = None
    ...
    def device_create_texture(
        self, device_id: Any, desc: TextureDescriptor, id_in: Optional[Any] = None
    ) -> Tuple[Any, Optional[Any]]:
        ...
        try:
            ...
            if self.hub and hasattr(self.hub, "textures"):
                texture_id = (
                    id_in if id_in is not None else self.hub._next_id("texture")
                )
    ...
    def device_create_command_encoder(
        self, device_id: Any, desc: Any, id_in: Optional[Any] = None
    ) -> Tuple[Any, Optional[Any]]:
        ...
        try:
            ...
            if self.hub and hasattr(self.hub, "command_encoders"):
                encoder_id = (
                    id_in if id_in is not None else self.hub._next_id("command_encoder")
                )
    ...
    def device_create_render_pipeline(
        ...
        try:
            ...
            if self.hub and hasattr(self.hub, "render_pipelines"):
                pipeline_id = (
                    id_in if id_in is not None else self.hub._next_id("render_pipeline")
                )
        ...
        try:
            ...
            if self.hub and hasattr(self.hub, "compute_pipelines"):
                pipeline_id = (
                    ...
                    else self.hub._next_id("compute_pipeline")
                )
        ...
        try:
            ...
            if self.hub and hasattr(self.hub, "bind_group_layouts"):
                layout_id = (
                    id_in
                    if id_in is not None
                    else self.hub._next_id("bind_group_layout")
                )
    ...
    def device_create_pipeline_layout(
        ...
        try:
            ...
            if self.hub and hasattr(self.hub, "pipeline_layouts"):
                layout_id = (
                    id_in if id_in is not None else self.hub._next_id("pipeline_layout")
                )
    ...
    def device_create_bind_group(
        ...
        try:
            ...
            if self.hub and hasattr(self.hub, "bind_groups"):
                group_id = (
                    id_in if id_in is not None else self.hub._next_id("bind_group")
                )
    ...
    def device_create_shader_module(
        self, device_id: Any, desc: Any, source: Any, id_in: Optional[Any] = None
    ) -> Tuple[Any, Optional[Any]]:
        ...
        try:
            ...
            if self.hub and hasattr(self.hub, "shader_modules"):
                shader_id = (
                    id_in if id_in is not None else self.hub._next_id("shader_module")
                )
    ...
    def device_create_sampler(
        ...
        try:
            ...
            if self.hub and hasattr(self.hub, "samplers"):
                sampler_id = (
                    id_in if id_in is not None else self.hub._next_id("sampler")
                )
    ...
    def device_create_query_set(
        ...
        try:
            ...
            if self.hub and hasattr(self.hub, "query_sets"):
                query_id = (
                    id_in if id_in is not None else self.hub._next_id("query_set")
                )
    ...
    def device_create_texture_view(
        self, device_id: Any, texture_id: Any, desc: Any, id_in: Optional[Any] = None
    ) -> Tuple[Any, Optional[Any]]:
        ...
        try:
            ...
            if hasattr(self.hub, "texture_views"):
                view_id = (
                    id_in if id_in is not None else self.hub._next_id("texture_view")
                )
    ...
    def device_poll(self, device_id: Any, maintain: Any = None) -> Any:
    ...
    def device_destroy(self, device_id: Any) -> None:
        ...
        try:
            ...
            if (
                self.hub
                and hasattr(self.hub, "devices")
                and device_id in self.hub.devices
            ):
                del self.hub.devices[device_id]
        except Exception:
            pass

    def device_set_lost_closure(self, device_id: Any, closure: Any) -> None:
    ...
    def device_configure_surface(
        self, device_id: Any, surface_id: Any, config: Any
    ) -> Optional[Any]:
    ...
    def render_bundle_encoder_finish(
        self, bundle_encoder: Any, desc: Any, id_in: Optional[Any] = None
    ) -> Tuple[Any, Optional[Any]]:
        ...
        try:
            ...
            if self.hub and hasattr(self.hub, "render_bundles"):
                bundle_id = (
                    id_in if id_in is not None else self.hub._next_id("render_bundle")
                )
    ...
    def device_create_pipeline_cache(
        ...
        try:
            ...
            if self.hub and hasattr(self.hub, "pipeline_caches"):
                cache_id = (
                    id_in if id_in is not None else self.hub._next_id("pipeline_cache")
                )
