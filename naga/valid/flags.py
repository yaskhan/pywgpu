...
class ValidationFlags(IntFlag):
    ...
    CONTROL_FLOW_UNIFORMITY = (
        0x4  # Uniformity of control flow for operations that require it
    )
...
class Capabilities(IntFlag):
    ...
    SHADER_INT64_ATOMIC_MIN_MAX = (
        1 << 20
    )  # Support for AtomicFunction::Min and Max on 64-bit integers
    ...
    TEXTURE_AND_SAMPLER_BINDING_ARRAY_NON_UNIFORM_INDEXING = (
        1 << 32
    )  # Support for non-uniform indexing
    BUFFER_BINDING_ARRAY_NON_UNIFORM_INDEXING = (
        1 << 33
    )  # Support for non-uniform indexing of uniform buffers
    STORAGE_TEXTURE_BINDING_ARRAY_NON_UNIFORM_INDEXING = (
        1 << 34
    )  # Support for non-uniform indexing of storage textures
    STORAGE_BUFFER_BINDING_ARRAY_NON_UNIFORM_INDEXING = (
        1 << 35
    )  # Support for non-uniform indexing of storage buffers
