...
This is a lightweight translation of parts of `wgpu-trunk/naga/src/back/hlsl/writer.rs`.

The full HLSL backend is still being ported; this writer supports the
expression variants used by the current simplified HLSL backend.
"""
...
class HLSLExpressionWriter:
    """Writes Naga IR expressions as HLSL source."""
