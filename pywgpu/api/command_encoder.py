...
class CommandEncoder:
    ...
    def copy_texture_to_texture(
        ...
        if hasattr(self._inner, "copy_texture_to_texture"):
            ...
            raise NotImplementedError(
                "Backend does not support copy_texture_to_texture"
            )

    def clear_buffer(
        self, buffer: "Buffer", offset: int = 0, size: Optional[int] = None
    ) -> None:
    ...
    def build_acceleration_structures(
        ...
        if hasattr(self._inner, "build_acceleration_structures"):
            ...
            raise NotImplementedError(
                "Backend does not support build_acceleration_structures"
            )
