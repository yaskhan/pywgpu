...
class ComputePass:
    ...
    def dispatch_workgroups(
        ...
        if hasattr(self._inner, "dispatch_workgroups"):
            self._inner.dispatch_workgroups(
    ...
    def dispatch_workgroups_indirect(
        ...
        if hasattr(self._inner, "dispatch_workgroups_indirect"):
            self._inner.dispatch_workgroups_indirect(
                indirect_buffer._inner, indirect_offset
            )
        else:
            raise NotImplementedError(
                "Backend does not support dispatch_workgroups_indirect"
            )
