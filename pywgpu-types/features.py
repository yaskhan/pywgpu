...
class Features(IntFlag):
    ...
    RAY_TRACING = 1 << 39
    RAY_QUERY = 1 << 40
    TIMESTAMP_QUERY_INSIDE_PASSES = 1 << 41
    MAPPABLE_PRIMARY_BUFFERS = 1 << 42
    NATIVE_POWER_PREFERENCE = 1 << 43
    NATIVE_PRESENT_MODE = 1 << 44
    BUFFER_BINDING_ARRAY = 1 << 45
    SAMPLED_TEXTURE_ARRAY_NON_UNIFORM_INDEXING = 1 << 46
    STORAGE_TEXTURE_ARRAY_NON_UNIFORM_INDEXING = 1 << 47
    UNSIZED_BINDING_ARRAY = 1 << 48
    MULTI_VIEW = 1 << 49
    DEPTH_CLAMP = 1 << 50
    SHADER_INT64 = 1 << 51
    SHADER_INT16 = 1 << 52
    SHADER_PRIMITIVE_INDEX = 1 << 53
    SHADER_EARLY_DEPTH_TEST = 1 << 54
    SHADER_DEVICE_ADDRESS = 1 << 55
    SHADER_FLOAT64 = 1 << 56
    SHADER_ATOMIC_I64 = 1 << 57
    SHADER_ATOMIC_F32_ADD = 1 << 58
    SHADER_ATOMIC_F32_MIN_MAX = 1 << 59
    SHADER_ATOMIC_F64_ADD = 1 << 60
    SHADER_ATOMIC_F64_MIN_MAX = 1 << 61
    SPIRV_SHADER_PASSTHROUGH = 1 << 62
    MULTIVIEW_EXT = 1 << 63
