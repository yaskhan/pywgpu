...
class Dispatch:
    ...
    def __init__(self, device: Any, limits: dict):
        ...
        self.module = device.create_shader_module(
            label="Indirect Dispatch Validation Shader", source=source
        )
        ...
        self.pipeline_layout = device.create_pipeline_layout(
            ...
            bind_group_layouts=[self.dst_bind_group_layout, self.src_bind_group_layout],
            immediate_size=4,
        )
        ...
        self.pipeline = device.create_compute_pipeline(
            ...
            stage={"module": self.module, "entry_point": "main"},
        )
